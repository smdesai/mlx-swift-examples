...
You will need to set the Team on the LLMApp target in order to build and
run on iOS.

Some notes about the setup:

- this downloads models from hugging face so LLMApp -> Signing & Capabilities has the "Outgoing Connections (Client)" set in the App Sandbox
